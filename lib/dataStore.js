// lib/dataStore.js
//
// Local, file-backed data layer standing in for a headless CMS (HyGraph).
// Every function here maps 1:1 to what a HyGraph GraphQL query/mutation
// would do, so swapping the body of each function for a `graphql-request`
// call against HyGraph later does not require touching any calling code
// in the API routes or pages.
